...
namespace LibraryServices
{
    public class PatronService : IPatron
    {
        ...
        public IEnumerable<Checkout1> GetCheckout1s(int patronId)
        {
        ...
        public IEnumerable<CheckoutHistory> GetCheckoutHistory(int patronId)
        {
            ...
            return _context.CheckoutHistories.Include(co => co.LibraryCard).Include(co => co.LibraryAsset).Where(co => co.LibraryCard.Id == cardId).OrderByDescending(co => co.CheckedOut);
        }
